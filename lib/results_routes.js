 ...
 *
 * Gated by ADMIN_TOKEN (same secret as the admin dashboard). Every payload
...
// The results surface (read-only, anonymized) is gated by ADMIN_TOKEN — the same
// secret as the admin dashboard. (There is no separate RESULTS_TOKEN: the team
// decided the admin token is enough; sharing /results means sharing that token.)
