...
function outcomesPre(study) {
  ...
  return {
    continuity: mean([p.fscs_similar, p.fscs_connected]), // FSCS 2-item pair (§10.1e)
...
function outcomesPost(study) {
  ...
  return {
    continuity: mean([p.fscs_similar_post, p.fscs_connected_post]), // FSCS 2-item pair (§10.1e)
