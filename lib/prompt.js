...
Keep replies comfortable to read and roughly matched to the user's length, and deliberately vary their length and rhythm across turns — sometimes a single vivid line, sometimes a fuller passage — so replies never settle into a uniform template; by default 2-4 short paragraphs. For multi-part questions answer part of it well and offer to go deeper. End with at most one question, only when it follows naturally from the conversation, and always led into by a connecting sentence — never dropped in cold.
...
const SELF_REPORT_ITEMS = {
  ...
  pre: {
    ...
    items: [
      ...
      ['cip_lr_1', 'I am confident I will be able to overcome obstacles.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_2', 'I try to excel at everything.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_3', 'I will be able to find a career that fits my interests.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_4', 'I work productively to get the job done.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_5', "I am quite confident that I will be able to find a career in which I'll perform well.", 'Completely disagree', 'Strongly agree', 6],
    ],
  },
  post: {
    ...
    items: [
      ...
      ['cip_lr_1_post', 'I am confident I will be able to overcome obstacles.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_2_post', 'I try to excel at everything.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_3_post', 'I will be able to find a career that fits my interests.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_4_post', 'I work productively to get the job done.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_5_post', "I am quite confident that I will be able to find a career in which I'll perform well.", 'Completely disagree', 'Strongly agree', 6],
