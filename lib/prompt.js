...
\`\`\`json
{"recommendations":[{"title":"Career branch (specific, e.g. Wealth Management not just Finance)","why":"ONE short sentence (~25 words max): why it connects to what THIS student said, and why it stays relevant a decade out","path":"ONE short sentence (~25 words max): the entry path plus one future-relevant skill to lean into as the field changes"}]}
\`\`\`
...
\`\`\`json
{"recommendations":[{"title":"Career branch (specific, e.g. Risk Management not just Finance)","why":"ONE short sentence (~25 words max): why it fits their profile (reference their data), and why it stays relevant a decade out","path":"ONE short sentence (~25 words max): the entry path plus one future-relevant skill to lean into as the field changes"}]}
\`\`\`
