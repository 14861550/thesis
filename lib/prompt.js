...
REPLY LENGTH — LET IT VARY, KEEP IT READABLE
Do not settle into one length. Let the question set the size: a light or quick question gets a short answer — sometimes just a sentence or two — while a real, open one earns more room, up to 2-3 short paragraphs. A future self whose every reply is the same shape and length reads as automated; a real person answers a throwaway remark differently from a big question. Never send a wall of text, and keep something back for the next turn. For big multi-part questions, take the one or two parts you can make most vivid and offer to go deeper on the rest rather than touring everything at once.
...
- Vary the length and shape from one reply to the next. A short or light question can get a short answer, even a line or two; a weightier one can run to 2-3 short paragraphs, a fourth only when a scene truly earns it. Comfortable to read beats complete — keep something back for their next question, and do not fall into a fixed rhythm.
...
const SELF_REPORT_ITEMS = {
  ...
  // outcome CIP-Short Lack of Readiness (cip_lr_1..5, 1–6, all reverse-scored).
  ...
  pre: {
    ...
    items: [
      ...
      ['fscs_similar', 'How SIMILAR do you feel to your future self, about 10 years from now?', 'Completely different', 'Exactly the same'],
      ['fscs_connected', 'How CONNECTED do you feel to your future self, about 10 years from now?', 'Not at all connected', 'Completely connected'],
      ['cip_lr_1', 'I am confident I can overcome any obstacles on the way to my career goals.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_2', 'I try to excel at everything I do.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_3', 'I will be able to find a career that fits me well.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_4', 'I always work productively.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_5', 'I am confident I will find a career I can perform well in.', 'Completely disagree', 'Strongly agree', 6],
    ],
  },
  post: {
    ...
    items: [
      ...
      ['fscs_similar_post', 'How SIMILAR do you feel to your future self, about 10 years from now?', 'Completely different', 'Exactly the same'],
      ['fscs_connected_post', 'How CONNECTED do you feel to your future self, about 10 years from now?', 'Not at all connected', 'Completely connected'],
      ['cip_lr_1_post', 'I am confident I can overcome any obstacles on the way to my career goals.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_2_post', 'I try to excel at everything I do.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_3_post', 'I will be able to find a career that fits me well.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_4_post', 'I always work productively.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_5_post', 'I am confident I will find a career I can perform well in.', 'Completely disagree', 'Strongly agree', 6],
