...
const SELF_REPORT_ITEMS = {
  ...
  pre: {
    ...
    items: [
      ...
      ['cip_lr_1', 'I am confident I can overcome obstacles.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_2', 'I try to excel at everything.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_3', 'I will be able to find a career.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_4', 'I always work productively.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_5', "I am confident I can find a career I'll perform well in.", 'Completely disagree', 'Strongly agree', 6],
    ],
  },
  post: {
    ...
    items: [
      ...
      ['cip_lr_1_post', 'I am confident I can overcome obstacles.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_2_post', 'I try to excel at everything.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_3_post', 'I will be able to find a career.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_4_post', 'I always work productively.', 'Completely disagree', 'Strongly agree', 6],
      ['cip_lr_5_post', "I am confident I can find a career I'll perform well in.", 'Completely disagree', 'Strongly agree', 6],
