...
const SELF_REPORT_ITEMS = {
  // Item ids + wording mirror the human instruments in survey.jsx (closeness =
  // the single IOS overlap item — the FSCS pair was dropped on supervisor
  // feedback 14 Jun 2026; vividness + manip checks verbatim; + the v5.1 distal
  // outcomes CDSE-SA on 1–5 and CIP-CCA on 1–6 — §14b sync), so silicon
  // self-reports stay comparable to human data. Tuple: [id, text, loAnchor,
  // hiAnchor, maxPoint] (maxPoint defaults to 7).
  pre: {
